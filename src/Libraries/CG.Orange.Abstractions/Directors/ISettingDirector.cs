...
/// <summary>
/// This interface represent an object that performs setting
/// related operations.
/// </summary>
public interface ISettingDirector
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="settingFile">The model to disable.</param>
    /// <param name="userName">The user name of the person performing the 
    /// operation.</param>
    /// <param name="cancellationToken">A cancellation token that is monitored
    /// for the lifetime of the method.</param>
    ...
    /// </summary>
    /// <param name="settingFile">The model to enable.</param>
    /// <param name="userName">The user name of the person performing the 
    /// operation.</param>
    /// <param name="cancellationToken">A cancellation token that is monitored
    /// for the lifetime of the method.</param>
