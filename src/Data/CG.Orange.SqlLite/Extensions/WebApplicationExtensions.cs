...
public static class WebApplicationExtensions002
{
    ...
    /// <summary>
    /// This method runs the DAL startup logic for the <see cref="CG.Orange"/> 
    /// project.
    /// </summary>
        ...
        )
    {
        ...
        var orangeDbContext = scope.ServiceProvider.GetRequiredService<
            OrangeDbContext
            >();
        ...
        webApplication.Logger.LogDebug(
            ...
            orangeDbContext.Database.GetDatabaseName(),
            orangeDbContext.Database.GetServerName()
            );

        // Drop any existing database.
        await orangeDbContext.Database.EnsureDeletedAsync(
            cancellationToken
